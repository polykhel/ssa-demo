...
public class CloudConfigInfoContributor implements InfoContributor {
    ...
    public CloudConfigInfoContributor(
        ConfigServerConfig configServerConfig, ConfigClientProperties configClientProperties) {
    ...
    public void contribute(Info.Builder builder) {
        ...
        builder.withDetail(
            "cloud-config-server-configuration-sources", configServerConfig.getComposite());
    }
}
